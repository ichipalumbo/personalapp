// [TAG-LEGADO-MODAL] _legado-modal.js
// ⚠️ LEGADO: Modal original da grade semanal simples (#modalAgendar). Verificar se ainda é usado antes de remover.
// Responsabilidade: Criação e cancelamento de aulas pela grade legada
// Depende de: state.js (aulas, alunos, HORARIOS), _legado-agenda.js (getAulaNoIntervalo), alunos-helpers.js (getAlunosParaSelect), utils-kpi.js (mostrarToast)
let modalDia = '';
